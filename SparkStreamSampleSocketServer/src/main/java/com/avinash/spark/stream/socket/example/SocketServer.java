package com.avinash.spark.stream.socket.example;
...
public class SocketServer {
	...
	public static void main(String[] args) {
    	...
    	Path path = FileSystems.getDefault()
    			.getPath("F:/Javascript_Tech/Spark/1_spark_complete_course/SparkEclpise/SparkStreamSampleSocketServer/data", 
    					"streamingtweets.txt");
